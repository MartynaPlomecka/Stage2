...
koncowa = read.csv("/Users/mplome/data/et_full_data.csv", 
                     header = TRUE, sep=",")
...
newdata_correctness = 
  data.frame(age = levels(koncowa$age), type = 1)
newdata_correctness
#pro
...
pro_vs_anti = fit_old[,"1"] - fit_old[,"0"] 
mean(pro_vs_anti>0)
...
pro_vs_anti = fit_young[,"1"] - fit_young[,"0"] 
mean(pro_vs_anti>0)
...
library(gridExtra)
library(gridBase)
#my = grid.arrange(p1, p2,p3, p4, nrow = 2, top=textGrob("Correctness of performance", #gp=gpar(fontsize=28,fontface = "bold")))
